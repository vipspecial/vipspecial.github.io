(function (global) {
  ...
  function shellMarkup() {
    return [
      ...
      '<div class="chat-history__head"><div><span>CONTEXT ARCHIVE</span><strong>会话脉络</strong></div><button type="button" data-new-chat aria-label="新建对话">＋</button></div>',
      '<div class="chat-history__list" data-conversation-list><div class="history-loading">正在读取历史...</div></div>',
      '<div class="chat-history__foot"><i></i><span>MongoDB memory online</span></div>',
      '</aside>',
      ...
      '<div><span>智能对话中枢</span><small>QWEN 3.6 / GROQ INFERENCE</small></div>',
      '<b><i></i> LIVE STREAM</b>',
      '</header>',
  ...
  function emptyMarkup() {
    return [
      ...
      '<span class="chat-empty__eyebrow">COGNITIVE WORKSPACE / ONLINE</span>',
      '<h1>把复杂问题，<br>变成清晰答案。</h1>',
      '<p>连接推理、知识与行动。提出一个问题，让系统从结构化思考开始。</p>',
      '<div class="chat-prompts">',
      '<button type="button" data-prompt="帮我设计一个 RAG 系统的最小可行架构">设计 RAG 架构 <i>↗</i></button>',
      '<button type="button" data-prompt="解释 AI Agent 的核心组成，并给出工程建议">构建 Agent 系统 <i>↗</i></button>',
      '<button type="button" data-prompt="帮我把一个复杂问题拆成清晰的执行步骤">拆解复杂任务 <i>↗</i></button>',
      '</div>',
      '</div>'
    ].join('')
  }
